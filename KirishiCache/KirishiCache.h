...
#include "KirishiLruPart.h"
#include "KirishiLfuPart.h"
#include <memory>
...
class KirishiCache : public KirishiCachePolicy<Key, Value> 
{
public:
    explicit KirishiCache(size_t capacity = 10, size_t transformThreshold = 2)
        : capacity_(capacity)
